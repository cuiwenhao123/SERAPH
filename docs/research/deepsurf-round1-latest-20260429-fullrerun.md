...
- Generated at: `2026-04-29 22:49:54`
- Workspaces: `/tmp/seraph-deepsurf-round1-fullrerun-20260429`
...
| RUSTSAN | arenavec-0.1.1 | 8 | `api::arenavec::common::SliceVec::split_off` | `runtime_error` | `failed/ok/bug` | - |
...
| RUSTSAN | id-map-0.2.1 | 4 | `api::id_map::IdMap::into_iter` | `bug` | `ok/ok/bug` | - |
...
| RUSTSAN | sized-chunks-0.6.2 | 26 | `api::sized_chunks::sparse_chunk::SparseChunk::get_unchecked` | `validated` | `ok/ok/ok` | - |
...
| RUSTSAN | smallvec-0.6.3 | 12 | `api::smallvec::SmallVec::drain` | `validated` | `failed/ok/ok` | - |
| RUSTSAN | stack-0.3.0 | 12 | `api::stack::array_vec::ArrayVec::into_inner` | `validated` | `ok/ok/ok` | - |
